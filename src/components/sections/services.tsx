      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-[var(--muted-foreground)]">
            Brindamos una amplia gama de servicios especializados para apoyar el crecimiento
            profesional, académico y personal de cada individuo.
          </p>
        </div>
...
function ServiceCard({ service }: { service: Service }) {
  ...
  return (
    <div className="group rounded-xl border border-[var(--border)] bg-[var(--card)] p-6 transition-all duration-300 hover:border-[var(--primary)] hover:shadow-lg hover:shadow-mac-green-500/5">
      ...
      <h3 className="mb-2 font-semibold text-[var(--card-foreground)]">{service.title}</h3>
